...
eflow=2; sqo=eflow+1; fsc2=sqo+1; qsc2=fsc2+1; fum=qsc2+1; bypas=fum+1; qh=bypas+1; psi=qh+1; fc1=psi+1; rosc2=fc1+1; lkc1=rosc2+1; fc2=lkc1+1;
...
set ylabel "fc2" offset 2;
#set yrange [-0.1:0.1]
plot fn1 using ($1):fc2 w l ls 1 not, fn2 using ($1):fc2 w l ls 2 not;
